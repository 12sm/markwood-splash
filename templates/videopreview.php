    ...
    <div class="row">
      <form action="submit">
        ...
        <div class="atag col-xs-12">
          <img src="wp-content/themes/splash/assets/img/arrow-left.png"><a href="videopreview.php" type="button" id="submitEmail">SUBMIT</a><img src="wp-content/themes/splash/assets/img/arrow-right.png">
        </div>
      </form>
    </div>
  </div>
